...
const app = () => {
    ...
    responses.push(findShortestRoute(Routes, Routes.getStop(shortestRouteTripSettings.start), 0, shortestRouteTripSettings, 0, Infinity));
    responses.push(findShortestRoundTripRoute(Routes, Routes.getStop(shortestRouteRoundTripSettings.start), 0, shortestRouteRoundTripSettings, 0, Infinity, true, 0, []));
